...
3. **Compares byte-for-byte** against the reference SVG stored **next to the generator source file** (same stem, `.svg` extension, e.g. `boxes/generators/boxes/abox.svg`).
